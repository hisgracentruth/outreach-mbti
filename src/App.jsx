  ...
  const results = {
    ...
    'CSIL': { 
      ...
      description: [
        ...
        '구조형 성향 덕분에 팀 운영에 있어서 규칙과 일정을 잘 세우고 지켜요. 회의 시간, 보고 양식, 연락 체계 등 기본적인 틀을 명확히 해서 팀원들이 혼란 없이 움직이도록 해요. 동시에 정해진 규칙을 어기는 일이 생기면 부드럽지만 단호하게 바로잡아 질서를 유지하는 데에도 능숙해요. 이러한 원칙 있는 돌봄으로 팀은 안정감을 얻고, 어려운 상황에서도 당신을 믿고 따르게 돼요.',
    ...
    'CSIB': { 
      ...
      description: [
        ...
        '구조형 기질이어서 맡은 역할을 체계적으로 수행해요. 약속 시간을 철저히 지키고, 해야 할 일은 체크리스트를 만들어 빠뜨리지 않고 챙겨요. 팀 내에서 정해진 규칙이나 계획을 성실히 따라가기 때문에 함께 일하는 사람들이 당신을 매우 신뢰해요. 어떤 일을 맡겨도 흐트러짐 없이 끝까지 완수하는 성실함이야말로 펭귄형의 가장 큰 강점이에요.',
    ...
    'CSXL': { 
      ...
      description: [
        ...
        '구조형 기질답게 시간 약속, 안전 수칙 등 기본 규율을 철저히 지켜요. 사전에 계획한 일정과 프로세스를 최대한 준수하면서도, 현장에서 예상치 못한 문제가 생기면 직접 뛰어들어 빠르게 해결책을 찾아요. 팀원들에게 책임감을 심어주되, 잘 안 될 땐 함께 짐을 나르기도 하는 리더십의 균형감을 갖추고 있어요. 이런 리더 덕분에 팀은 안심하고 맡은 일에 집중할 수 있어요.',
